...
public class PdfService {
    ...
    /**
     * Convert text into pdf file
     * we adapted code in @see <a href="https://www.roseindia.net/java/java-conversion/TextToPDF.shtml">convert text to pdf</a>
     * @param String text to convert into pdf
     * @param String path to file parent directory
     * @param String name of the pdf file
     * @return void
     */
    public void textToPdf(String text, String filePath, String filename) throws FileNotFoundException, DocumentException {
